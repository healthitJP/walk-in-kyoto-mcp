...
const RouteSearchByNameService_1 = require("../../src/services/RouteSearchByNameService");
...
class MockRouteSearchByGeoService {
    searchRoute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fromStation = nearestStations[request.from_latlng] || '不明駅';
            const toStation = nearestStations[request.to_latlng] || '不明駅';
            return {
                routes: [{
                        summary: {
                            depart: '2025-07-07T05:31',
...
describe('Route Search Integration Tests', () => {
    let nameSearchService;
    let geoSearchService;
    beforeEach(() => {
    ...
    describe('IT-3: search_route_by_name 出発指定', () => {
        it('should find routes with departure time specification', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = {
                language: 'ja',
                max_tokens: 1024,
                from_station: '浄土寺',
            ...
            const result = yield nameSearchService.searchRoute(request);
        ...
        it('should return valid JSON schema', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = {
                language: 'ja',
                max_tokens: 1024,
                from_station: '浄土寺',
    ...
    describe('IT-4: search_route_by_name 到着指定', () => {
        it('should find routes with arrival time specification', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = {
                language: 'ja',
                max_tokens: 1024,
                from_station: '浄土寺',
    ...
    describe('IT-6: search_route_by_geo Geo-to-Geo', () => {
        it('should find routes using geographical coordinates', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = {
                language: 'ja',
                max_tokens: 1024,
            ...
            const result = yield geoSearchService.searchRoute(request);
            expect(result.routes).toHaveLength(1);
        ...
        it('should handle latitude longitude format correctly', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = {
                language: 'ja',
                max_tokens: 1024,
                from_latlng: '35.02527,135.79189',
    ...
    describe('IT-7: Error-BadStop', () => {
        it('should return 404 for non-existent station', () => __awaiter(void 0, void 0, void 0, function* () {
            // モックを使って「見つからない」場合をシミュレート
            const mockFetcher = {
                fetchByName: jest.fn().mockResolvedValue('<html><body>該当する結果が見つかりませんでした</body></html>')
            };
            const testService = new RouteSearchByNameService_1.RouteSearchByNameService(mockFetcher, new RouteHtmlParser_1.RouteHtmlParser(), new TokenLimiter_1.TokenLimiter(), new RequestValidator_1.RequestValidator());
            const request = {
                language: 'ja',
                max_tokens: 1024,
                from_station: '不存在',
            ...
            try {
                const result = yield testService.searchRoute(request);
        ...
        it('should handle both stations not found', () => __awaiter(void 0, void 0, void 0, function* () {
            // モックを使って「見つからない」場合をシミュレート
            const mockFetcher = {
                fetchByName: jest.fn().mockResolvedValue('<html><body>該当する結果が見つかりませんでした</body></html>')
            };
    ...
    describe('IT-8: Downstream Timeout', () => {
        it('should handle upstream timeout gracefully', () => __awaiter(void 0, void 0, void 0, function* () {
            // タイムアウトシミュレーション
            ...
            yield expect(timeoutService.searchRoute()).rejects.toThrow('Upstream timeout');
        }));
    ...
    describe('Language Support', () => {
        it('should support English language responses', () => __awaiter(void 0, void 0, void 0, function* () {
            const request = {
                language: 'en',
                max_tokens: 1024,
                from_station: 'Jodoji',
